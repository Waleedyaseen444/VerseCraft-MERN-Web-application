...
import CharacterHistory from './Sidebar'; 
...
function App() {
  ...
  return (
    <body className="avatar-app-body" >
    ...
    <div className="avatar-app-container">
              ...
              characterHistory.map((character, index) => (
                <div key={index} className="avatar-character-profile">
                  <div className="avatar-profile-image">
                    <img src={`https://robohash.org/${character.name}.png?size=100x100`} alt="Character Avatar" />
                  </div>
                  <table>
                    <tbody>
                      <tr>
      ...
      <main className="avatar-main-content">
        ...
        <CharacterHistory history={characterHistory} setCharacterHistory={setCharacterHistory} />
      </main>
    </div>
    </body>
  );
